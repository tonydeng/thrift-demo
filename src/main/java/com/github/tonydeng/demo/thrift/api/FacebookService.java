 ...
 *  @generated
 */
package com.github.tonydeng.demo.thrift.api;
...
public class FacebookService {
  ...
  public interface Iface {
    ...
    public void setOption(String key) throws org.apache.thrift.TException;
    ...
    public void reinitalize() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void setOption(String key, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void reinitalize(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_setOption(String key) throws org.apache.thrift.TException
    {
    ...
    public void send_reinitalize() throws org.apache.thrift.TException
    {
      reinitalize_args args = new reinitalize_args();
      sendBase("reinitalize", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void setOption(String key, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      setOption_call method_call = new setOption_call(key, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class setOption_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String key;
      public setOption_call(String key, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.key = key;
      }
    ...
    public void reinitalize(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      reinitalize_call method_call = new reinitalize_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class reinitalize_call extends org.apache.thrift.async.TAsyncMethodCall {
      public reinitalize_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("reinitalize", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        reinitalize_args args = new reinitalize_args();
        args.write(prot);
        prot.writeMessageEnd();
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("reinitalize", new reinitalize());
    ...
    public static class reinitalize<I extends Iface> extends org.apache.thrift.ProcessFunction<I, reinitalize_args> {
      public reinitalize() {
        super("reinitalize");
      }

      public reinitalize_args getEmptyArgsInstance() {
        return new reinitalize_args();
      }
      ...
      public org.apache.thrift.TBase getResult(I iface, reinitalize_args args) throws org.apache.thrift.TException {
        iface.reinitalize();
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class setOption<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, setOption_args, Void> {
      ...
      public void start(I iface, setOption_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.setOption(args.key,resultHandler);
      }
    }
    ...
    public static class reinitalize<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, reinitalize_args, Void> {
      public reinitalize() {
        super("reinitalize");
      }
      ...
      public void start(I iface, reinitalize_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.reinitalize(resultHandler);
      }
    }
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.success = com.github.tonydeng.demo.thrift.api.Status.findByValue(iprot.readI32());
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
...
;
  ...
  public static class reinitalize_args implements org.apache.thrift.TBase<reinitalize_args, reinitalize_args._Fields>, java.io.Serializable, Cloneable, Comparable<reinitalize_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("reinitalize_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new reinitalize_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new reinitalize_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(reinitalize_args.class, metaDataMap);
    }

    public reinitalize_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public reinitalize_args(reinitalize_args other) {
    }

    public reinitalize_args deepCopy() {
      return new reinitalize_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof reinitalize_args)
        return this.equals((reinitalize_args)that);
      return false;
    }

    public boolean equals(reinitalize_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(reinitalize_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("reinitalize_args(");
      boolean first = true;
    ...
    private static class reinitalize_argsStandardSchemeFactory implements SchemeFactory {
      public reinitalize_argsStandardScheme getScheme() {
        return new reinitalize_argsStandardScheme();
      }
    }

    private static class reinitalize_argsStandardScheme extends StandardScheme<reinitalize_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, reinitalize_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reinitalize_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class reinitalize_argsTupleSchemeFactory implements SchemeFactory {
      public reinitalize_argsTupleScheme getScheme() {
        return new reinitalize_argsTupleScheme();
      }
    }

    private static class reinitalize_argsTupleScheme extends TupleScheme<reinitalize_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, reinitalize_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, reinitalize_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
